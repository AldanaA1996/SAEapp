...
// Definimos un tipo para los materiales que buscamos, para tener mejor autocompletado.
...
function EgressMaterialForm() {
  ...
  const onSubmit = async (values: z.infer<typeof schema>) => {
    ...
    //   En un entorno real, usarías un sistema de notificaciones (toast)
    form.reset();
    setSearchTerm('');
    setSelectedMaterial(null);

    // **SOLUCIÓN:** Se muestra un alert claro con los detalles del retiro exitoso.
      ...
      // Si buscas de nuevo "Pinceles", verás que la cantidad disponible ha disminuido.
